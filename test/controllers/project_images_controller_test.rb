...
class ProjectImagesControllerTest < ActionController::TestCase
  ...
  test "should create project_image" do
    assert_difference('ProjectImage.count') do
      post :create, project_image: { caption: @project_image.caption, image: @project_image.image, project_id: @project_image.project_id }
    end
  ...
  test "should update project_image" do
    patch :update, id: @project_image, project_image: { caption: @project_image.caption, image: @project_image.image, project_id: @project_image.project_id }
    assert_redirected_to project_image_path(assigns(:project_image))
  end
